...
import { CompactRequest, CompactResponse, CreateSessionRequest, CreateSessionResponse, CreateTenantRequest, CreateTenantResponse, DeletePresetRequest, DeletePresetResponse, DeleteProviderRequest, DeleteProviderResponse, DeleteSessionRequest, DeleteSessionResponse, DeleteTenantRequest, DeleteTenantResponse, DiscoverGatewayModelsRequest, DiscoverGatewayModelsResponse, ForkRequest, ForkResponse, GetAgentConfigRequest, GetAgentConfigResponse, GetConfigRequest, GetConfigResponse, GetFileMetaRequest, GetFileMetaResponse, GetFileRequest, GetFileResponse, GetSessionRequest, GetSessionResponse, GetToolConfigRequest, GetToolConfigResponse, HealthRequest, HealthResponse, IngestFileRequest, IngestFileResponse, InterruptRequest, InterruptResponse, IssueTenantTokenRequest, IssueTenantTokenResponse, ListMessagesRequest, ListMessagesResponse, ListModelsRequest, ListModelsResponse, ListPresetsRequest, ListPresetsResponse, ListProvidersCatalogRequest, ListProvidersCatalogResponse, ListProvidersRequest, ListProvidersResponse, ListSessionsRequest, ListSessionsResponse, ListTenantsRequest, ListTenantsResponse, ListTenantTokensRequest, ListTenantTokensResponse, ListToolsRequest, ListToolsResponse, MailboxRequest, MailboxResponse, PreviewPresetRequest, PreviewPresetResponse, PromptRequest, PromptResponse, RegisterProviderRequest, RegisterProviderResponse, RenameRequest, RenameResponse, RevokeTenantTokenRequest, RevokeTenantTokenResponse, RotateTenantTokenRequest, RotateTenantTokenResponse, SetConfigRequest, SetConfigResponse, SetExtensionConfigRequest, SetExtensionConfigResponse, SetModelRequest, SetModelResponse, SetToolConfigRequest, SetToolConfigResponse, StateRequest, StateResponse, TestProviderRequest, TestProviderResponse, UndoRequest, UndoResponse, UpdateSettingsRequest, UpdateSettingsResponse, UpdateTenantRequest, UpdateTenantResponse, UploadFileRequest, UploadFileResponse, UpsertPresetRequest, UpsertPresetResponse, WatchSessionRequest, WatchSessionResponse, WatchSessionsRequest, WatchSessionsResponse } from "./agent_pb.js";
...
export const AgentService = {
  ...
  methods: {
    ...
    discoverGatewayModels: {
      name: "DiscoverGatewayModels",
      I: DiscoverGatewayModelsRequest,
      O: DiscoverGatewayModelsResponse,
      kind: MethodKind.Unary,
    },
    /**
...
export const AdminService = {
  typeName: "agent.v1.AdminService",
  methods: {
    /**
     ...
     */
    listTenantTokens: {
      name: "ListTenantTokens",
      I: ListTenantTokensRequest,
      O: ListTenantTokensResponse,
      kind: MethodKind.Unary,
    },
    /**
     ...
     */
    revokeTenantToken: {
      name: "RevokeTenantToken",
      I: RevokeTenantTokenRequest,
      O: RevokeTenantTokenResponse,
      kind: MethodKind.Unary,
    },
    /**
     ...
     */
    rotateTenantToken: {
      name: "RotateTenantToken",
      I: RotateTenantTokenRequest,
      O: RotateTenantTokenResponse,
      kind: MethodKind.Unary,
    },
  }
} as const;
